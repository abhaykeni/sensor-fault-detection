...
class DataIngestion:
    ...
    def export_data_into_feature_store(self)->DataFrame:
        """
        Export mongodb collection record as data frame into feature store.
        """
        try:
            logging.info("Exporting mongo db collection record to feature store.")
    ...
    def split_data_as_train_test(self, dataframe:DataFrame)->None:
        """
        Exported data from feature store dataset will be split into train and test file.
        """
        try:
